...
class Word2VecModel():
    ...
    def train(self, dataset):
        ...
        self.model.train(dataset,
                         ...
                         epochs=self.epochs)
        self.model.save("/home/parker/code/datadex/NaturalLanguageProcessing/LSTM/log/w2v.model")
    ...
    def vectorize_sentence(self, sentence):
        ...
        if isinstance(sentence, list):
            try:
                path = "/home/parker/code/datadex/NaturalLanguageProcessing/LSTM/log/w2v.model"
