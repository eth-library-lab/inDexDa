...
class NLPModel():
    ...
    def train(self, dataset):
        ...
        if not os.path.exists('.log/d2v.model'):
            ...
            self.model.save("/home/parker/code/datadex/NaturalLanguageProcessing/Doc2Vec/log/d2v.model")
    ...
    def doc_vector(self, doc):
        ...
        '''
        try:
            path = "/home/parker/code/datadex/NaturalLanguageProcessing/Doc2Vec/log/d2v.model"
