...
class XPLORE:
    ...
    def __init__(self, apiKey):
        ...
        # flag for Open Access, which changes endpoint in use and limits results to just
        #  Open Access
        self.usingOpenAccess = False

        # flag that article number has been provided, which overrides all other search
        #  criteria
        ...
        # data format for results; default is raw (returned string); other option is
        #  object
        ...
        self.allowedSearchFields = ['abstract', 'affiliation', 'article_number',
                                    'article_title', 'author', 'boolean_text',
                                    'content_type', 'd-au', 'd-pubtype', 'd-publisher',
                                    'd-year', 'doi', 'end_year', 'facet', 'index_terms',
                                    'isbn', 'issn', 'is_number', 'meta_data',
                                    'open_access', 'publication_number',
                                    'publication_title', 'publication_year', 'publisher',
                                    'querytext', 'start_year', 'thesaurus_terms']
    ...
    # string outputDataFormat   Data structure for the returned result (raw string or
    #   object)
    # return void
    ...
    def searchField(self, field, value):
        ...
        if field in self.allowedSearchFields:
            ...
            print("Searches against field {} are not supported".format(field))
    ...
    def addParameter(self, parameter, value):
        ...
        if (len(value) > 0):
            ...
            if (parameter == 'facet' or parameter == 'd-au' or parameter == 'd-year' or
                    parameter == 'd-pubtype' or parameter == 'd-publisher'):
        ...
        # boolean query
            ...
            for key in self.parameters:
                ...
                if (self.usingFacet and self.facetApplied is False):
                    ...
                    url += ('&querytext=' + urllib.quote_plus(self.parameters[key]) +
                            '&facet=' + key)
